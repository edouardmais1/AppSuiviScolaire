...
<div class="bloc-modale" v-if="reveleUpdate">
    ...
    <div class="modale card" >
        ...
        <div class="btn-modale-check btn btn-success" v-on:click="updateEleve()"> Oui <i class="fas fa-solid fa-check"></i></div>
        <div class="btn-modale-cancel btn btn-danger" v-on:click="toggleModaleUpdate">Annulé <i class="fas fa-solid fa-ban"></i></div>
    </div>
    </div>
</template>

...
<div class="bloc-modale" v-if="reveleDelete">
    ...
    <div class="modale card" >
        ...
        <div class="btn-modale-check btn btn-success" v-on:click="deleteActualite()"> Oui <i class="fas fa-solid fa-check"></i></div>
...
export default{
    name: 'ModaleDeleteActualite',
    props: ['reveleDelete', 'toggleModaleDelete', 'id'],

    methods:{
        async deleteActualite(){
                console.log(this.id);
                let destinationUrl = url.concatUrl("/deleteActualite/" + this.id);

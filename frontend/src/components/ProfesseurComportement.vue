<template>
    ...
    <div class="row">
        ...
        <div class="containerSecretariatEleves">
            ...
            <GestionComportement v-for="item in items[0]" :key="item" v-bind:eleveId="item.EleveID" v-bind:date="item.Date" v-bind:signature="item.Signature" v-bind:contenu="item.Contenu"></GestionComportement>
    </div>
    </section>
</template>
